...
insert  into `items_buom`(`item_buom_id`,`itemNo`,`base_qty`,`base_unit`,`equiv_qty`,`equiv_unit`) values (1,39,10,'PC',1,'PACK'),(3,39,100,'PC',1,'BOX');
...
insert  into `items_buom_list`(`uomid`,`unit_name`,`unit_description`) values (1,'PC','Piece'),(2,'BOX','Box'),(3,'REAM','Ream'),(4,'CASE','Case'),(5,'CARTON','Carton'),(6,'KG','Kilogram'),(7,'L','Litre');
